...
const AddProduct = () => {
    ...
    return (
        <div>
            ...
            <h2 className="text-center text-5xl bg-red-600">This Page Will go in the admin panel</h2>
            <h2 className="text-center text-5xl">Add Product Here</h2>
            <form onSubmit={handleAddProduct} className="bg-slate-100 card-body w-3/4 mx-auto">
